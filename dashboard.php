...
<body>
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="dashboard.php?page=settings"><i class="fas fa-cog"></i> Account</a></li>
        <li><a href="dashboard.php?page=registration"><i class="fas fa-clipboard-list"></i> Trainee Info</a></li>
